            ...
            <div class="carousel owl-carousel">
                <div class="card">
                    <div class="box">
                        ...
                        <p>A responsive social network project, using HTML and CSS.</p>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
                        ...
                        <p>A blog with a responsive structure, using HTML and CSS.</p>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
                        ...
                        <p>A restaurant site containing a table and a form, using HTML and CSS.</p>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
                        <img src="./Images/profile_1.jpg" alt="">
                        <div class="text">Someone name4</div>
                    ...
                    <div class="icons">
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">Florent Tandjune Tamoyem</div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">Kaiserslautern, Germany</div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">tandjunetamoyem@gmail.com</div>
                            </div>
                        </div>
                    </div>
                </div>
